...
class MomentMediaService:
    ...
    def begin(self, actor, file_name, mime_type, byte_size, key):
        ...
        with self.factory.begin() as session:
            ...
            row = MomentMediaUpload(id=upload_id, owner_id=actor, file_name=file_name, mime_type=mime_type, byte_size=byte_size, status="PENDING", object_key=f"moments/{actor}/{upload_id}", idempotency_key=key, created_at=now, expires_at=now + timedelta(minutes=30))
