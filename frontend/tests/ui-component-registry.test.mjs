...
test("Flutter–HTML registry names every HTML component contract", () => {
  ...
  assert.ok(!Object.hasOwn(registry, "figma"), "retired Figma export ledger must not be fabricated");
});
