...
export const componentContracts = Object.freeze([
  ...
  defineContract({ tagName: "app-secondary-button", rootClass: "c-secondary-button", allowedAttributes: ["tone", "label", "disabled", "action"], allowedStates: ["neutral", "danger", "disabled"], domSignature: [".c-secondary-button", ".c-secondary-button>.c-secondary-button__label"] }),
  ...
  defineContract({ tagName: "app-emoji-input-decoration", rootClass: "c-emoji-input-decoration", allowedAttributes: ["text"], allowedStates: ["default", "animated"], domSignature: [".c-emoji-input-decoration"] }),
  defineContract({ tagName: "app-message-selection-session", rootClass: "c-selection-demo", allowedAttributes: ["state"], allowedStates: ["active", "dragging", "settled", "dismissed"], domSignature: [".c-selection-demo", ".c-selection-demo>.c-selection-demo__text", ".c-selection-demo>.c-selection-demo__menu"] }),
  ...
  defineContract({ tagName: "app-gradient-divider", rootClass: "c-gradient-divider", allowedAttributes: [], allowedStates: ["default"], domSignature: [".c-gradient-divider"] }),
  ...
  defineContract({ tagName: "app-identity-header", rootClass: "c-identity-header", allowedAttributes: ["name", "username", "signature", "image", "official"], domSignature: [".c-identity-header", ".c-identity-header>.c-identity-header__avatar", ".c-identity-header>.c-identity-header__body"] }),
  defineContract({ tagName: "app-official-name", rootClass: "c-official-name", allowedAttributes: ["name", "official"], domSignature: [".c-official-name", ".c-official-name>.c-official-name__text"] }),
  ...
  defineContract({ tagName: "app-voice-bubble", rootClass: "c-voice-bubble", allowedAttributes: ["duration", "playback", "direction"], allowedStates: ["idle", "loading", "playing", "paused", "failed"], domSignature: [".c-voice-bubble", ".c-voice-bubble>.c-voice-bubble__wave", ".c-voice-bubble>.c-voice-bubble__duration"] }),
  ...
  defineContract({ tagName: "app-dialog", rootClass: "c-dialog-overlay", allowedAttributes: ["title", "message", "kind", "confirm", "cancel", "hide-cancel"], allowedStates: ["confirm", "error", "detail", "danger"], domSignature: [".c-dialog-overlay", ".c-dialog-overlay>.c-overlay", ".c-dialog-overlay>.c-overlay>.c-dialog"] }),
  defineContract({ tagName: "app-action-sheet", rootClass: "c-action-sheet-overlay", allowedAttributes: ["title", "options", "selected", "variant"], domSignature: [".c-action-sheet-overlay", ".c-action-sheet-overlay>.c-overlay", ".c-action-sheet-overlay>.c-overlay>.c-action-sheet"] }),
  ...
  defineContract({ tagName: "app-network-capsule", rootClass: "c-network-capsule", allowedAttributes: ["state", "label", "disabled"], allowedStates: ["offline", "reconnecting", "connecting", "service-unavailable", "restored"], domSignature: [".c-network-capsule", ".c-network-capsule>.c-network-capsule__icon", ".c-network-capsule>.c-network-capsule__label"] }),
  defineContract({ tagName: "app-red-packet-card", rootClass: "c-red-packet", allowedAttributes: ["state", "greeting", "viewer-claim", "status-label", "action"], allowedStates: ["available", "claimed", "exhausted", "expired", "withdrawn"], domSignature: [".c-red-packet", ".c-red-packet>.c-red-packet__body", ".c-red-packet>.c-red-packet__footer"] }),
  defineContract({ tagName: "app-transfer-card", rootClass: "c-transfer-card", allowedAttributes: ["amount", "state", "viewer-role", "action"], allowedStates: ["pending", "accepted", "returned"], domSignature: [".c-transfer-card", ".c-transfer-card>.c-transfer-card__body", ".c-transfer-card>.c-transfer-card__footer"] }),
  ...
  defineContract({ tagName: "app-group-member-picker", rootClass: "c-group-member-picker", allowedAttributes: ["title", "state", "selected"], allowedStates: ["ready", "loading", "empty", "error"], domSignature: [".c-group-member-picker", ".c-group-member-picker>.c-group-member-picker__title", ".c-group-member-picker>.c-group-member-picker__list"] }),
  ...
  defineContract({ tagName: "app-moment-reactions", rootClass: "c-moment-reactions", allowedAttributes: ["likes", "comments", "detail", "selected", "own", "time"], domSignature: [".c-moment-reactions", ".c-moment-reactions>.c-moment-reactions__likes", ".c-moment-reactions>.c-moment-reactions__comments"] }),
  ...
  defineContract({ tagName: "app-moments-feed-v2", rootClass: "c-moments-feed-v2", allowedAttributes: ["mode"], allowedStates: ["latest", "loading", "error", "empty"] }),
  defineContract({ tagName: "app-moment-cover-viewer", rootClass: "c-moment-cover-viewer", allowedAttributes: ["url", "loading", "error"], allowedStates: ["default", "loading", "error", "empty"] }),
]);
