...
register("chat", "transfer", [
  ["pending", "聊天转账 / 待收款"], ["accepted", "聊天转账 / 已收款"],
  ["returned", "聊天转账 / 已退还"], ["insufficient", "聊天转账 / 余额不足"]
]);
...
register("redpacket", "create", [["limits-loading", "红包 / 获取限额"], ["limits-failed", "红包 / 限额失败与重试"], ["group-equal", "红包 / 普通红包"], ["group-random", "红包 / 拼手气红包"], ["group-exclusive", "红包 / 专属红包"], ["direct-equal", "红包 / 私聊普通红包"], ["fields", "红包 / 输入字段"], ["amount-invalid", "红包 / 金额错误"], ["count-invalid", "红包 / 份数错误"], ["minimum-invalid", "红包 / 最低金额错误"], ["confirm", "红包 / 创建确认"], ["submitting", "红包 / 创建中"], ["failed", "红包 / 创建失败"], ["success", "红包 / 创建成功"]]);
