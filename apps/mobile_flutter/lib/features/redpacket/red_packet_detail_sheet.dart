...
final class RedPacketDetailSheet extends StatefulWidget {
  const RedPacketDetailSheet(
      {super.key, required this.api, required this.packetId});
  final BusinessApiClient api;
  final String packetId;
  @override
  State<RedPacketDetailSheet> createState() => _RedPacketDetailSheetState();
}
            ...
            child: SizedBox(
                ...
                child: Padding(
                  ...
                  child: controller.loading && detail == null
                      ...
                      : Column(children: [
                          WeChatRedPacketCard(
                              greeting: '恭喜发财，大吉大利', state: state),
                          ...
                          ModernActionButton(
                              ...
                              onPressed:
                                  state == RedPacketVisualState.available &&
                                          !controller.loading
                                      ? () => controller.claim(widget.packetId)
                                      : null),
                        ]),
                ))));
  }
