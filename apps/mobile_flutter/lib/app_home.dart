  ...
  Widget build(BuildContext context) => CupertinoTabScaffold(
    ...
    tabBuilder: (_, index) => CupertinoTabView(
      builder: (_) => switch (index) {
        ...
        _ => ProfilePage(api: api, onLogout: onLogout),
      },
    ),
  );
}
        ...
        children: [
            ...
            onTap: () => Navigator.push(
              ...
              CupertinoPageRoute(
                builder: (_) => CupertinoPageScaffold(
                  navigationBar: const CupertinoNavigationBar(middle: Text('彩币')),
          ...
          WeChatListTile(
            ...
            onTap: () => Navigator.push(
              ...
              CupertinoPageRoute(
                builder: (_) => CupertinoPageScaffold(
                  navigationBar: const CupertinoNavigationBar(middle: Text('红包')),
