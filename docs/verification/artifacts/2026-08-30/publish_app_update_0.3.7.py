"""发布 0.3.7+10 应用更新设置（在 starchat-business-api-1 容器内执行）。
...
IDEMPOTENCY_KEY = "app-update-publish-0.3.7-20260830"
APK_URL = f"https://www.liuhetong888.com/downloads/ChatFlow-{RELEASE_VERSION}-arm64.apk"
NOTES = (
    "0.3.7 版本更新：修复退出应用一段时间后需要重新登录的问题，"
    "同一设备登录状态可保持 60 天（60 天内活跃即自动续期）。"
    "超级表情与 emoji 矢量渲染优化。"
)
