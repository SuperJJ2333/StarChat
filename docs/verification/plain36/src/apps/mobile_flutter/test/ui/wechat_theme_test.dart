...
void main() {
  ...
  test('figma foundation exposes mobile geometry and semantic icons', () {
    ...
    expect(WeChatRadius.avatar, WeChatRadius.control);
    expect(WeChatTypography.actionButtonIcon, 20);
    expect(WeChatTypography.avatarInitialScale, .4);
    expect(WeChatMotion.actionPressScale, .98);
