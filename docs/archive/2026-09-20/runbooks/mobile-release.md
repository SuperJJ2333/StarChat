> **Historical / 已由新入口替代 · 2026-09-20 文档整理。** 原路径 `docs/runbooks/mobile-release.md`。原有日期、版本及验收结论仅代表当时记录；当前入口：[操作索引](../../../runbooks/mobile-release.md)。本文不作为新的部署或资金操作授权。
...
[Runbooks index](../../../runbooks/README.md) · [Final artifact deployment](../../../runbooks/app-release-deployment.md).

Android delivery policy (user-confirmed 2026-09-05): follow [the mandatory APK rebuild/signing runbook](../../../runbooks/android-apk-rebuild.md) after the source build. Commands below create intermediate Android artifacts; they do not by themselves complete the final packaging process.
