> **Historical / 一次性发布或旧协议 · 2026-09-20 文档整理。** 原路径 `docs/runbooks/admin-readability-deployment.md`。原有日期、版本及验收结论仅代表当时记录；当前入口：[操作索引](../../../runbooks/admin-production-workflow.md)。本文不作为新的部署或资金操作授权。
