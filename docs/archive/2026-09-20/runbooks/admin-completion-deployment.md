> **Historical / 一次性发布或旧协议 · 2026-09-20 文档整理。** 原路径 `docs/runbooks/admin-completion-deployment.md`。原有日期、版本及验收结论仅代表当时记录；当前入口：[操作索引](../../../runbooks/admin-production-workflow.md)。本文不作为新的部署或资金操作授权。

# 管理后台完整交付与受控人工修复发布

适用：2026-09-10后台账目筛选与用户资料、链上/事故详情弹窗及受保护的人工资金修复入口。发布不等于执行充值、提现、事故结案或任何自动资金操作。先读 [admin-production-workflow.md](../../../runbooks/admin-production-workflow.md)；权限、幂等、链证据、钱包二次验证及最终提交前校验继续有效。
