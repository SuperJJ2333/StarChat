...
- [ ] **Step 2: 最小实现 `ConversationListTile`**
...
- [ ] **Step 4: 将真实 Matrix 房间映射到 Figma 节点 `30:2`**
...
- [ ] **Step 2: 将 `RoomPage` 映射到 Figma 节点 `30:31`**
...
- [ ] **Step 3: 补充 RoomPage 静态边界断言并运行 focused tests**
...
- [ ] **Step 1: 写失败的 CallPage Widget 测试**
...
- [ ] **Step 5: 运行 CallPage 与控制器测试并确认 Green**
...
- [ ] **Step 1: 运行格式、静态分析与 Flutter 全量测试**

```powershell
C:\src\flutter\bin\dart.bat format --output=none --set-exit-if-changed apps/mobile_flutter/lib apps/mobile_flutter/test
