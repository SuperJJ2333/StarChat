...
- [x] **Step 3: Implement the versioned record**
...
- [x] **Step 3: Implement minimum session APIs**
...
- [x] **Step 1: Add a failing factory contract test**
...
- [x] **Step 3: Add pinned compatible dependencies**
...
- [x] **Step 4: Implement the factory**
...
- [x] **Step 3: Implement minimum transitions**
...
- [x] **Step 3: Implement the composition root and gate**
...
- [x] **Step 1: Run specification-compliance review**
...
- [x] **Step 2: Run Quality/Security review**
...
- [x] **Step 4: Execute two-emulator acceptance**
