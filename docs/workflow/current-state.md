...
## 2026-09-20 iOS TestFlight 内部测试（修复通过共享测试，原生夹具排查中）

用户确认内部测试邀请，候选0.3.103/2145包含重启会话恢复与权限宏/设置跳转修复。3701 Flutter测试通过；目前CI35521565834复验相册原生授权夹具，尚未上传新IPA。以[任务](tasks/2026-09-20-ios-testflight-permissions.md)为准；无需再次请求构建或内部分发授权。
