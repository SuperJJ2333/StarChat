...
export const componentContracts = Object.freeze([
  ...
  defineContract({ tagName: "app-navigation-bar", rootClass: "c-navigation-bar", allowedAttributes: ["title", "leading", "action"], domSignature: [".c-navigation-bar", ".c-navigation-bar>.c-navigation-bar__leading", ".c-navigation-bar>.c-navigation-bar__title", ".c-navigation-bar>.c-navigation-bar__actions"] }),
